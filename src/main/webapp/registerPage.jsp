    ...
    <div class="regFieldContainer">
        ...
        <div class="row">
            <form action="register" method="post">
                ...
                <div class="row center mb-4"> <div class="col-12"> <input class="input" id="password" type="password" name="password" value="${param.password}" placeholder="Password" pattern="^(?=.*[A-Z])(?=.*[a-z])(?=.*\d)(?=.*[@$!%_*#?&])[A-Za-z\d@$!%_*#?&]{8,100}$" required></div></div>
